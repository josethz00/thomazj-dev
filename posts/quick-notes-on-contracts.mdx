---
title: 'Quick notes on smart contracts'
description: 'What are smart contracts? Which problems do they solve? How do they work? What are the programming languages for smart contracts? What are the security issues?'
date: '2023-01-14'
tags: ['quicknotes', 'blockchain', 'programming']
---
