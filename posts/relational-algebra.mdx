...
description: Relational Algebra is a theoretical language for describing queries and data manipulation. It is the basis for SQL and other query languages.
date: '2023-02-25'
...
purpose is to query and manipulate data. But attention! Relational Algebra is not a programming language, it's more like
a math notation, a formal and theoretical language.
