...
$$
ARGENTINIAN_PLAYERS \leftarrow \sigma_{countryId = 1}(players) \\
BRAZILIAN_PLAYERS \leftarrow \sigma_{countryId = 3}(players) \\
ARGENTINIAN_PLAYERS \cup BRAZILIAN_PLAYERS
$$
